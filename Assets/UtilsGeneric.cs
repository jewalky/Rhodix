...
/// <summary>
/// This class replaces Printf for the purpose of parsing original ROM2 locale strings (which use %s, %u and such).
...
public partial class Utils
{
    ...
    // own functions
    public static string GetNullTermString(byte[] inb)
    {
        int ioz = inb.Length;
        ...
        return Encoding.ASCII.GetString(inb, 0, ioz);
    }
}
